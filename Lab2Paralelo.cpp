...
// Mario Guerra - 21008
// Daniel Valdez - 21240
// Programa paralelo que escribe N números aleatorios a un archivo y los clasifica.
...
void quickSort(int* data, int lo, int hi) {
    ...
    #pragma omp task shared(data) if(hi-lo > 1000) // Controla el tamaño mínimo para la creación de tareas
    quickSort(data, lo, h);

    #pragma omp task shared(data) if(hi-lo > 1000)
    quickSort(data, l, hi);
